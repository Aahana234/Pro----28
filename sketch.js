...
function setup() {
	...
	mango1 = new Mango(1000,340,40,200);
	mango2 = new Mango(680,400,30,400);
	mango3 = new Mango(830,430,40,500);
	mango4 = new Mango(1000,430,30,90);
	mango5 = new Mango(800,300,50,100);

	stoneObj = new Stone(100,500,70);
	rope = new Rope(stoneObj.body,{x:150,y:550});
	//tree = (100,400,40,60);
...
function draw() {
  rectMode(CENTER);
  background(125);
  image(treeImage,600,200,600,500);
